...
CREATE TABLE `chaves` (
  ...
  `numeroChave` int NOT NULL, -- Numero da Sala
  `sala` varchar(60) DEFAULT NULL, -- Nome da Sala
  `bloco-predio` varchar(60) DEFAULT NULL, -- Bloco/ Prédio
  `observacoes` varchar(60) DEFAULT NULL, -- Decrições
  `quantChave` int NOT NULL, -- Se tiver reserva setar (2 chaves), Se NÃO tiver reserva setar (1 chave)
  `status` varchar(30) DEFAULT NULL, -- Adicionar por padrão como DISPONÍVEL
  PRIMARY KEY (`idChave`)
...
INSERT INTO `chaves` VALUES (1,124,'LABORATÓRIO 124', 'MODULO NOVO','Chave Principal',0,'DISPONÍVEL'),(2,115,'LABORATÓRIO 115', 'MODULO NOVO','Chave Principal',2,'DISPONÍVEL'),(3,118,'LABORATÓRIO 118', 'MODULO NOVO','Chave Principal',1,'DISPONÍVEL');
...
-- Dump completed on 2024-07-17 17:48:40
