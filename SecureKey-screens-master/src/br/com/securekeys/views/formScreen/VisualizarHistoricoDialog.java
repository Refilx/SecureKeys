 ...
 * @author adimael
 */
public class VisualizarHistoricoDialog extends javax.swing.JDialog {

    /**
     * Creates new form VisualizarUserDialog
     */
    public VisualizarHistoricoDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        jTableHistorico.getTableHeader().setFont( new Font( "Arial" , Font.BOLD, 24 ));
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Histórico de reservas");

//        jTableHistorico.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED));
//        jTableHistorico.setFont(new java.awt.Font("Inter", 0, 24)); // NOI18N
//        jTableHistorico.setModel(new javax.swing.table.DefaultTableModel(
//            new Object [][] {
//
//            },
//            new String [] {
//                "Nº SALA", "SOLICITANTE DA RESERVA", "CARGO", "DATA ABERTURA", "OBSERVAÇÃO", "DATA FECHAMENTO", "AÇÕES"
//            }
//        ));
        ...
        jTableHistorico = configurator.tableConfigHistorico(jTableHistorico, historicos, jScrollPane1);

        jTableHistorico = configurator.refreshHistorico(jTableHistorico, historicos, jScrollPane1);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VisualizarHistoricoDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                VisualizarHistoricoDialog dialog = new VisualizarHistoricoDialog(new javax.swing.JFrame(), true);
