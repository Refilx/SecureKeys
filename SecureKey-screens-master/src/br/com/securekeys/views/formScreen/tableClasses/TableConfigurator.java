...
//        Object[] images = {new ImageIcon(TableConfigurator.class.getClassLoader().getResource("br/com/securekeys/icons/key-recover.png")),
...
//        jTable.getColumnModel().getColumn(7).setCellRenderer(new ImageCellRenderer());
//        jTable.getColumnModel().getColumn(8).setCellRenderer(new ImageCellRenderer());
    ...
    public static JTable tableConfigHistorico(JTable table, Historico[] array, JScrollPane jScrollPane){
        ...
        table.setModel(new DefaultTableModel(
                ...
                new String[]{
                        "Nº da chave", "Nome da pessoa", "Cargo", "Observação", "Status", "Data de abertura", "Data de fechamento", "Finalizar","Excluir"
                }
        ));
