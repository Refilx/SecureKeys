 ...
 * @author adimael
 */
public class VisualizarUserDialog extends javax.swing.JDialog {

    /**
     * Creates new form VisualizarUserDialog
     */
    public VisualizarUserDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(1712, 960));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VisualizarUserDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                VisualizarUserDialog dialog = new VisualizarUserDialog(new javax.swing.JFrame(), true);
